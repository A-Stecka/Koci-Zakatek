...
<body>
    ...
    <div class="content_left">
        <h3>W ten sposób przechowujemy informację, o stylu, który wybrałaś/eś:</h3>
        
        <?php
            print("<strong>Nazwa ciasteczka: </strong> style<br>");
            print("<strong>Wartość ciasteczka: </strong>" . $_COOKIE["style"]);
        ?>
