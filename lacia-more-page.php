...
<body>
    <div class="header" id="lacia_header">
    ...
    <div class="content_center">
        <h1>Łacia</h1>
        <img class="cat_image" src="images/lacia-1.jpg" alt="Nie udało się załadować obrazu :(">
        <p>Łacia jest ok. 11-letnią kotką. Lubi zabawę z innymi kotami.</p>
        <h2>Rezultat w plebiscycie na najsłodszego kota</h2>
        <p>Łacia brała udział w plebiscycie na najsłodszego kota, który odbył się na naszym profilu na Facebooku.</p>
        <label for="meter">Wynik:</label>
        <meter min="0" max="100" value="68"></meter>
        <p>Łacia uzyskała łącznie 56 głosów! Wszystkim, którzy oddali głosy serdecznie dziękujemy.</p>
        <p><a href="#lacia_header">Wróć do góry strony</a></p>
