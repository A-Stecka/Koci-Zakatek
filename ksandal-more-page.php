...
<body>
    <div class="header" id="ksandal_header">
    ...
    <div class="content_center">
        <h1>Ksandal</h1>
        <img class="cat_image" src="images/ksandal-1.jpg" alt="Nie udało się załadować obrazu :(">
        <p>Ksandal jest ok. 5-letnim kocurem. Lubi zabawę z innymi kotami.</p>
        <h2>Rezultat w plebiscycie na najsłodszego kota</h2>
        <p>Ksandal brał udział w plebiscycie na najsłodszego kota, który odbył się na naszym profilu na Facebooku.</p>
        <label for="meter">Wynik:</label>
        <meter min="0" max="100" value="68"></meter>
        <p>Ksandal uzyskał łącznie 68 głosów i uplasował się na 3 miejscu! Wszystkim, którzy oddali głosy serdecznie
            dziękujemy.</p>
        <p><a href="#ksandal_header">Wróć do góry strony</a></p>
    </div>
