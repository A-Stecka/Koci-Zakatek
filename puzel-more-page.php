...
<body>
    <div class="header" id="puzel_header">
    ...
    <div class="content_center">
        <h1>Puzel</h1>
        <img class="cat_image" src="images/puzel-1.jpg" alt="Nie udało się załadować obrazu :(">
        <p>Puzel jest ok. 2 miesięcznym kocurem. Lubi zabawę z innymi kotami.</p>
        <h2>Rezultat w plebiscycie na najsłodszego kota</h2>
        <p>Puzel brał udział w plebiscycie na najsłodszego kota, który odbył się na naszym profilu na Facebooku.</p>
        <label for="meter">Wynik:</label>
        <meter min="0" max="100" value="84"></meter>
        <p>Puzel uzyskał łącznie 99 głosów i tym samym wygrał nasz plebiscyt! Wszystkim, którzy oddali głosy serdecznie
            dziękujemy.</p>
        <p><a href="#puzel_header">Wróć do góry strony</a></p>
    </div>
